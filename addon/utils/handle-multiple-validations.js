 ...
 */
export default function handleMultipleValidations(validators, { key, newValue, oldValue, changes, object }) {
  let validations = emberArray(validators
    .map((validator) => validator(key, newValue, oldValue, changes, object)));
